...
Die mobile Monatsansicht verwendet jetzt bis 700 px durchgehend das kompakte Transaktionskarten-Layout. Dadurch sehen die Karten auch auf größeren Smartphones und schmalen Tablet-Fenstern konsistent aus.

---

## 9.6.0-beta.39

### Mobile Monatsansicht
Der Bereich „Buchungen / Alle Transaktionen im …“ besitzt auf Smartphones wieder einen vollständigen Kartenrahmen mit den üblichen abgerundeten Fintra-Ecken.
...
### Privacy-Mode-Fix
Die vier Finanzdiagramme auf der Analytics-Seite werden im Privacy Mode jetzt genauso wie die Diagramme auf dem Dashboard geblurred.
...
### Monatsansicht
- Der Schatten unter „Buchungen“ und den Filterfeldern wurde entfernt.
- Die Sticky-Funktion bleibt unverändert erhalten.
...
### Transaktionsfilter
- Behebt einen 422-Fehler beim Anwenden von Filtern auf `/transactions`.
- Leere Auswahlfelder für Jahr, Monat und Kategorie werden nun als nicht gesetzte Filter interpretiert.
- CSV-Export und Transaktionsübersicht verarbeiten Filterparameter einheitlich.
...
### Fixkosten
- Beim Bearbeiten einer Fixkostenposition verschwindet die normale Bezeichnung und wird ausschließlich durch das Eingabefeld ersetzt.
- Dadurch ist der Editiermodus in den Fixkostentabellen kompakter und eindeutiger.
...
### Fixed
- Die horizontale Trennlinie der Jahresübersicht läuft wieder vollständig von der Bezeichnungsspalte bis zur Jahresspalte.
- Der neutrale Stil der Monatsbeträge beeinflusst keine Tabellenrahmen mehr.
